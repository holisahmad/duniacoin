...
if(isset($_GET['do'])) { 
    if($_GET['do']=='login') {
       if ( isset( $_SESSION['admin_login_billingsimpel'] ) ) { header('Location: ?do=mutasi'); die(); }
       $isLoginPage = 1;
    }
    if($_GET['do']=='signout') {
...
<head>
    ...
    <title>Mutasi Bank- Admin Panel</title>
...
<body>
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header"><a class="navbar-brand navbar-link" href="#">Mutasi Bank</a>
...
?>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>Mutasi Bank© <?php echo date('Y') ?> by <a href="https://dimaspratama.com/">solutionprofit</a></h5></div>
                 </div>
        </div>
    </footer>
...
<body>
    <aside></aside>
    <footer class="site-footer">
        <div class="login-card"><a href=""><h2>Mutasi Bank</h2></a>
            ...
            <form class="form-signin" action="?do=login" method="post"><span class="reauth-email"> </span>
                ...
                <input class="form-control" type="password" required placeholder="Kata sandi" id="inputPassword" name="secret" />
        ...
        <div class="container">
            ...
            <div class="row">
                 <div class="col-sm-6">
                    <h5>Mutasi Bank © <?php echo date('Y') ?> by <a href="">solutionprofit.com</a></h5></div>
                 </div>
        </div>
    </footer>
</body>
