...
function confirmation(noid, kat, page) {
	...
	if (answer){
		//alert("Bye bye!")
		window.location = "?e=data_auto&page=" + kat + "&no=" + noid;
	}
}
</script>
<?
...
?>
<p align="center"><strong>DATA PENJODOHAN AUTO</strong></p>
<table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <tr>
        <td><form action="" method="post" name="form1" id="form1" style="margin:0; padding:0">
          <label> Katagori Negara:
            ...
            <option value="?e=data_auto" selected="selected" <? echo $pilih; ?>>Semua negara</option>
            <option value="?e=data_auto&amp;kat=1&amp;sel3=<?= $sel; ?>" <? echo $sel3; ?>>Member Indonesia</option>
            <option value="?e=data_auto&amp;kat=0&amp;sel2=<?= $sel; ?>" <? echo $sel2; ?>>Member Malaysia</option>
          </select>
          </label>&nbsp;&nbsp;
        Total: <b><?= $numrows; ?></b> orang
        </form></td>
        <td><form id="form2" name="form2" method="post" action="?e=data_auto&amp;kat=2" style="margin:0; padding:0">
          <label>
            Cari Member : 
  ...
  <tr bgcolor="#FF0000" class="tbl_header">
    ...
    <td width="15%" align="center">NOMINAL </td>
    <td width="12%" align="center">PENERIMA-1</td>
    <td width="13%" align="center">NOMINAL-1</td>
    <td width="11%" align="center">PENERIMA-2</td>
    <td width="12%" align="center">NOMINAL</td>
    <td width="6%" align="center">PROSES</td>
...
$hari_ini=date("Y-m-d");
	...
	if($row[25] == 7) {
		$gantiph = "<strong><blink><font color='#FF0000'><a href='?e=data_auto&amp;page=gantiphbaru&id=$row[0]'>PA Batal dan Harus Di Ganti PA Baru</a></font></blink></strong>";
	} else if($row[25]==5) {
		$gantiph = "<strong><blink><font color='#FF0000'>AUTO</font></blink></strong>";
		} else {
		$gantiph = "-";
	}
...
?>  
  <tr class="<?= $class; ?>">
    ...
    <td align="center"><?= rupiah($row[8]); ?></td>
...
?>
  <a href="?e=data_auto&kat=<?= $kat; ?>&show=1" style="font-size:10px; color:#0000CC"><< First </a> | <a href="?e=data_auto&kat=<?= $kat; ?>&show=<?= $previous; ?>" style="font-size:10px; color:#0000CC">< Previous </a> |
  <?php
...
?>
[ <a href="?e=data_auto&kat=<?= $kat; ?>&show=<?= $i; ?>" style="font-size:10px; color:#0000CC">
<?= $i; ?>
</a> ]
<?php
...
?>
| <a href="?e=data_auto&kat=<?= $kat; ?>&show=<?= $next; ?>" style="font-size:10px; color:#0000CC">Next ></a> | <a href="?e=data_auto&kat=<?= $kat; ?>&show=<?= $paging; ?>" style="font-size:10px; color:#0000CC">Last >></a>
<?php
...
?>
  <?
	...
	case delete :
		...
		echo "<meta http-equiv='refresh' content='0;URL=?e=data_auto'>";
	break;
...
echo "<center><h2>Maaf Jumlah Pemberi Bantuan Tidak Sesuai Dengan Jumlah yang Anda Masukan</h2></center>";
	...
	echo "<meta http-equiv=\"refresh\" content=\"2; url=?e=data_auto\">";
}
}
