...
if($kat == 1) {
	$sql0 = $db->count_records("gh_start", "negara='Indonesia' and status=2" );
	$sql = $db->select("*", "gh_start", "negara='Indonesia' and status=2" , "", "", "", "$start, $limit");
	//mysql_close();
} else if($kat == 2) {
	...
	$sql0 = $db->count_records("gh_start", "negara='Malaysia'  and status=2 ");
	$sql = $db->select("*", "gh_start", "negara='Malaysia'  and status=2", "id desc", "", "", "$start, $limit");
} else {
...
?>
<p align="center"><strong>DATA RA PROSES (RA)</strong></p>
      ...
      <tr>
        <td><form action="" method="post" name="form1" id="form1" style="margin:0; padding:0">
          <label> Katagori Negara:
            ...
            <option value="?e=data_gh2" selected="selected" <? echo $pilih; ?>>Semua negara</option>
            <option value="?e=data_gh2&amp;kat=1&amp;sel3=<?= $sel; ?>" <? echo $sel3; ?>>Member Indonesia</option>
            <option value="?e=data_gh2&amp;kat=0&amp;sel2=<?= $sel; ?>" <? echo $sel2; ?>>Member Malaysia</option>
          </select>
          </label>&nbsp;&nbsp;
