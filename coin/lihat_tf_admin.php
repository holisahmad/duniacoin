...
function confirmation(mid, page, action) {
	...
	if (answer){
		//alert("Bye bye!")
		window.location = "?e=lihat_tf_admin&page=" + page + "&mid=" + mid + "&action=" + action;
...
<h2 align="center"><img src="../admin/images/icon-48-user.png" width="48" height="48" align="absmiddle" /> Username Prioritas </h2>
...
if($kat == 3) {
	$numrows = $db->count_records("member", "username like '%$keywrd%' or username like '%$keywrd%'");
	$db->select("id, username, nama, hp, sponsor, tgl_daftar, upline, kota, paket_daftar, status, blokir, negara , lev", "member", "username like '%$keywrd%' or username like '%$keywrd%'", $where, $order, "", "", "$start, $limit");
	
} else {
	$numrows = $db->count_records("member", "status=1 and lev=1");	
	$db->select("id, username, nama,  hp, sponsor, tgl_daftar, upline, kota, paket_daftar,status, blokir , negara, lev", "member", $where, $order, "", "", "$start, $limit");
}

if($kat == 1) {
$numrows = $db->count_records("member", "negara='Indonesia'  and lev=1");	
	$db->select("id, username, nama,  hp, sponsor, tgl_daftar, upline, kota, paket_daftar,status, blokir , negara ", "member", "negara='Indonesia' and lev=1", $order, "", "", "$start, $limit");
}
if($kat == 2) {
$numrows = $db->count_records("member", "negara='Malaysia' and lev=1");	
	$db->select("id, username, nama,  hp, sponsor, tgl_daftar, upline, kota, paket_daftar,status, blokir , negara", "member", "negara='Malaysia' and lev=1 ", $order, "", "", "$start, $limit");
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td colspan="12" align="center" style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding:0; margin:0">
	  ...
	  <td width="39%"><form action="" method="post" name="form1" id="form1" style="margin:0; padding:0">
          <label>  Negara:
            <select name="select" onChange="location =  this.options[this.selectedIndex].value" class="form">
            <option value="?e=lihat_tf_admin" selected="selected" <? echo $pilih; ?>>Semua negara</option>
            <option value="?e=lihat_tf_admin&amp;kat=1" >Member Indonesia</option>
            <option value="?e=lihat_tf_admin&amp;kat=2" >Member Malaysia</option>
          </select>
          </label>&nbsp;&nbsp;
        Total: <b><?= $numrows; ?></b> orang
        </form></td>
		
        <td width="14%"><form action="" method="post" name="form1" id="form1" style="margin:0; padding:0">
        </form></td>
        <td width="47%"><form id="form2" name="form2" method="post" action="?e=lihat_tf_admin&amp;kat=3" style="margin:0; padding:0">
          <label>
            Cari Member : 
  ...
  <tr bgcolor="#FF0000" class="tbl_header">
    ...
    <td width="11%" align="center">Nama Lengkap</td>
    <td width="8%" align="center">Sponsor</td>
    <td width="7%" align="center">Upline</td>
	<td width="9%" align="center">Paket</td>
    <td width="11%" align="center">Kota</td>
	<td width="15%" align="center">Negara</td>
    <td width="13%" align="center">Tgl Join</td>
    <td width="5%" align="center">Status</td>
    <td width="5%" align="center">Blokir</td>
...
?>
  ...
  <tr class="<?= $class; ?>">
    ...
    <td align="center"><a href="?e=lihat_tf_admin&page=addnew&edit=1&mid=<?= $db->result($i, "username"); ?>"><?= $db->result($i, "nama"); ?></a></td>
	...
	<td align="center"><?= $db->result($i, "Negara"); ?></td>
...
?>
        <a href="?e=lihat_tf_admin&amp;kat=<?= $kat; ?>&amp;show=1" style="font-size:10px; color:#0000CC">&lt;&lt; Awal </a> | <a href="?e=lihat_tf_admin&amp;kat=<?= $kat; ?>&amp;show=<?= $previous; ?>" style="font-size:10px; color:#0000CC">&lt; Sebelumnya </a> |
      <?php
...
?>
      [ <a href="?e=lihat_tf_admin&amp;kat=<?= $kat; ?>&amp;show=<?= $i; ?>" style="font-size:10px; color:#0000CC">
        <?= $i; ?>
        </a> ]
      <?php
...
?>
      | <a href="?e=lihat_tf_admin&amp;kat=<?= $kat; ?>&amp;show=<?= $next; ?>" style="font-size:10px; color:#0000CC">Selanjutnya &gt;</a> | <a href="?e=lihat_tf_admin&amp;kat=<?= $kat; ?>&amp;show=<?= $paging; ?>" style="font-size:10px; color:#0000CC">Terakhir &gt;&gt;</a>
      <?php
...
<p>&nbsp; </p>
<form action="?e=lihat_tf_admin&amp;page=submit" method="post">
        ...
        <td width="100%" style="border-style: none; border-width: medium"><div align="left">
            <table height="50" cellspacing="0" cellpadding="0" width="100%" border="0" style="border-collapse: collapse">
              <tbody>
                ...
                <tr>
                  <td>&nbsp;Upline&nbsp;</td>
                  <td>: <?= "<a href='?e=lihat_tf_admin&page=addnew&edit=1&mid=".$db->dataku("upline", $mid)."'>".$db->dataku("upline", $mid)." (".$db->dataku("nama", $db->dataku("upline", $mid)).")"; ?>                  </td>
                </tr>
                <tr>
                  <td>&nbsp;Email</td>
                  <td>:
...
<?	
	...
	echo "<meta http-equiv='refresh' content='0;URL=?e=lihat_tf_admin&page=addnew&act=1&mid=$mid&edit=1'>";
		
			
	} else {
		echo "<meta http-equiv='refresh' content='0;URL=?e=lihat_tf_admin'>";
	}		
...
//$bulan=array("Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember");
    ...
    <td width="42%" align="right"><form id="form4" name="form2" method="post" action="?e=lihat_tf_admin&amp;page=komisi" style="margin:0; padding:0">
      <label> Cari Member :
      <input name="keywrd" type="text" id="keywrd" />
</label>
      <label>
...
?>
  ...
  <tr class="<?= $class; ?>">
    <td width="4%"><?= $nom; ?> </td>
    <td width="18%"><a href="?e=lihat_tf_admin&page=detilkomisi&mid=<?= $username; ?>&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>"><?= $username; ?></a></td>
...
?>
  <a href="?e=lihat_tf_admin&page=komisi&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>&show=1" style="font-size:10px; color:#0000CC"><< Awal </a> | <a href="?e=lihat_tf_admin&page=komisi&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>&show=<?= $previous; ?>" style="font-size:10px; color:#0000CC">< Sebelumnya </a> |
  <?php
...
?>
[ <a href="?e=lihat_tf_admin&page=komisi&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>&show=<?= $i; ?>" style="font-size:10px; color:#0000CC">
<?= $i; ?>
</a> ]
<?php
...
?>
| <a href="?e=lihat_tf_admin&page=komisi&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>&show=<?= $next; ?>" style="font-size:10px; color:#0000CC">Selanjutnya ></a> | <a href="?e=lihat_tf_admin&page=komisi&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>&show=<?= $paging; ?>" style="font-size:10px; color:#0000CC">Terakhir >></a>
<?php
...
//$bulan=array("Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember");
    ...
    <td width="42%" align="right"><form id="form4" name="form2" method="post" action="?e=lihat_tf_admin&amp;page=komisibulanan" style="margin:0; padding:0">
      <label> Cari Member :
      <input name="keywrd" type="text" id="keywrd" />
</label>
      <label>
...
?>
  <a href="?e=lihat_tf_admin&page=komisibulanan&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>&show=1" style="font-size:10px; color:#0000CC"><< Awal </a> | <a href="?e=lihat_tf_admin&page=komisibulanan&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>&show=<?= $previous; ?>" style="font-size:10px; color:#0000CC">< Sebelumnya </a> |
  <?php
...
?>
[ <a href="?e=lihat_tf_admin&page=komisibulanan&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>&show=<?= $i; ?>" style="font-size:10px; color:#0000CC">
<?= $i; ?>
</a> ]
<?php
...
?>
| <a href="?e=lihat_tf_admin&page=komisibulanan&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>&show=<?= $next; ?>" style="font-size:10px; color:#0000CC">Selanjutnya ></a> | <a href="?e=lihat_tf_admin&page=komisibulanan&bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>&show=<?= $paging; ?>" style="font-size:10px; color:#0000CC">Terakhir >></a>
<?php
