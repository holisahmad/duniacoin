...
function confirmation(noid, kat, page) {
	...
	if (answer){
		//alert("Bye bye!")
		window.location = "?e=data_gf&page=" + kat + "&no=" + noid;
	}
}
</script>
<?
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <tr>
        <td><form action="" method="post" name="form1" id="form1" style="margin:0; padding:0">
          <label> Katagori Negara:
            ...
            <option value="?e=data_gf" selected="selected" <? echo $pilih; ?>>Semua negara</option>
            <option value="?e=data_gf&amp;kat=1&amp;sel3=<?= $sel; ?>" <? echo $sel3; ?>>Member Indonesia</option>
            <option value="?e=data_gf&amp;kat=0&amp;sel2=<?= $sel; ?>" <? echo $sel2; ?>>Member Malaysia</option>
          </select>
          </label>&nbsp;&nbsp;
        Total: <b><?= $numrows; ?></b> orang
        </form></td>
        <td><form id="form2" name="form2" method="post" action="?e=data_gf&amp;kat=2" style="margin:0; padding:0">
          <label>
            Cari Member : 
  ...
  <tr bgcolor="#FF0000" class="tbl_header">
    ...
    <td width="9%" align="center">Deadline Pemasangan </td>
    <td width="7%" align="center">Harus Ganti PA</td>
...
$hari_ini=date("Y-m-d");
	...
	if($row[25] == 7) {
		$gantiph = "<strong><blink><font color='#FF0000'><a href='?e=data_gf&amp;page=gantiphbaru&id=$row[0]'>PA Batal dan Harus Di Ganti PA Baru</a></font></blink></strong>";
	} else if($row[25]==5) {
...
?>  
  <tr class="<?= $class; ?>">
    ...
    <td align="center"><a href="?e=data_gf&amp;page=edit&noid=<?= $row[0]; ?>"><img src="../admin/images/edit_f2.png" title="Edit PA" width="17" height="22" border="0" /></a></td>
...
?>
  <a href="?e=data_gf&kat=<?= $kat; ?>&show=1" style="font-size:10px; color:#0000CC"><< First </a> | <a href="?e=data_gf&kat=<?= $kat; ?>&show=<?= $previous; ?>" style="font-size:10px; color:#0000CC">< Previous </a> |
  <?php
...
?>
[ <a href="?e=data_gf&kat=<?= $kat; ?>&show=<?= $i; ?>" style="font-size:10px; color:#0000CC">
<?= $i; ?>
</a> ]
<?php
...
?>
| <a href="?e=data_gf&kat=<?= $kat; ?>&show=<?= $next; ?>" style="font-size:10px; color:#0000CC">Next ></a> | <a href="?e=data_gf&kat=<?= $kat; ?>&show=<?= $paging; ?>" style="font-size:10px; color:#0000CC">Last >></a>
<?php
...
?>
  <?
	...
	case delete :
		...
		echo "<meta http-equiv='refresh' content='0;URL=?e=data_gf'>";
	break;
...
echo "<center><h2>Maaf Jumlah Pemberi Bantuan Tidak Sesuai Dengan Jumlah yang Anda Masukan</h2></center>";
	...
	echo "<meta http-equiv=\"refresh\" content=\"2; url=?e=data_gf\">";
}
}
