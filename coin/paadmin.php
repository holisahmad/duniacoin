...
function confirmation(noid, kat, page) {
	...
	if (answer){
		//alert("Bye bye!")
		window.location = "?m=paadmin&page=" + kat + "&no=" + noid;
	}
}
</script>
<?
...
?>
<p align="center"><strong>DAFTAR PA FUND (PA)</strong></p>
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" style="border:solid #CCCCCC 1px">
  <tr class="tbl_header">
    <td colspan="2">&nbsp;</td>
    <td colspan="10"><form id="form2" name="form2" method="post" action="?m=paadmin&amp;kat=2" style="margin:0; padding:0">
          <label>
  ...
  <tr bgcolor="#FF0000" class="tbl_header">
    ...
    <td width="10%" align="center">NOMINAL GF</td>
    <td width="10%" align="center">PAKET GF</td>
    <td width="10%" align="center">PENERIMA-1</td>
    <td width="11%" align="center">NOMINAL-1</td>
    <td width="9%" align="center">Deadline Pemasangan PH</td>
    <td width="7%" align="center">Harus Ganti PH</td>
    <td width="5%" align="center">Admin Proses</td>
    <td width="8%" align="center">Pasangkan Manual</td>
...
$hari_ini=date("Y-m-d");
	...
	if($row[25] == 2) {
		$gantiph = "<strong><blink><font color='#FF0000'><a href='?m=paadmin&amp;page=gantiphbaru&id=$row[0]'>PH Batal dan Harus Di Ganti PH Baru</a></font></blink></strong>";
	} else if($row[25]==3) {
...
?>  
  <tr class="<?= $class; ?>">
    ...
    <td align="center"><a href="?m=paadmin&amp;page=edit&noid=<?= $row[0]; ?>"><img src="../admin/images/edit_f2.png" title="Edit PA" width="17" height="22" border="0" /></a></td>
...
?>
  <a href="?m=paadmin&kat=<?= $kat; ?>&show=1" style="font-size:10px; color:#0000CC"><< First </a> | <a href="?m=paadmin&kat=<?= $kat; ?>&show=<?= $previous; ?>" style="font-size:10px; color:#0000CC">< Previous </a> |
  <?php
...
?>
[ <a href="?m=paadmin&kat=<?= $kat; ?>&show=<?= $i; ?>" style="font-size:10px; color:#0000CC">
<?= $i; ?>
</a> ]
<?php
...
?>
| <a href="?m=paadmin&kat=<?= $kat; ?>&show=<?= $next; ?>" style="font-size:10px; color:#0000CC">Next ></a> | <a href="?m=paadmin&kat=<?= $kat; ?>&show=<?= $paging; ?>" style="font-size:10px; color:#0000CC">Last >></a>
<?php
...
?>
  <?
	...
	case delete :
		...
		echo "<meta http-equiv='refresh' content='0;URL=?m=paadmin'>";
	break;
...
echo "<center><h2>Maaf Jumlah Pemberi Bantuan Tidak Sesuai Dengan Jumlah yang Anda Masukan</h2></center>";
	...
	echo "<meta http-equiv=\"refresh\" content=\"2; url=?m=paadmin\">";
}
}
