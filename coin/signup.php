...
$db->insert("member", "", "NULL, '$username', '$pass', '$newtoken', '$nama', '$sponsor', '$upline', '$posisi', '$email', '$alamat', '$kota', '$hp', '$phone', '$negara', '$pinbb', '$foto', '$bank', '$norek', '$an', '$wd', '$acc', '$clientdate', '$setuju', '$clientdate', '$jlh_hari','0', '$paket_daftar', '0', '0', 'Reguler', '0' ");

$db->insert("jaringan", "", "NULL, '$username', '0', '0'");
...
$db->insert("card", "", "NULL, '$username', '0', '$clientdate'");

$db->insert("history_card", "", "NULL, '$user_session', '0',  '1', 'Aktivasi   $username', '$clientdate'");





$message= "Selamat Datang Di www.duniacoin.net User ID : ".$username.", Pass : ".$pass1." Token/pin : ".$newtoken." Terima Kasih.";
...
$norekx = "".($db->config("bank")).", ".($db->config("bank1")).", ".($db->config("bank2")).", ".($db->config("bank3"))."" ;
...
$db->insert("order_aktivasi", "", "NULL, '$username', '$nama', '$hp', '$jlh', '$clientdate','$limite', '$bank' ,'$rp', 'Paket','0'");
...
<p align="center">Data Token Akan Terkirim Ke Email Juga Namun Harap di Catat dan Di Simpan Dengan Baik, <br />
Token Akan Di Gunakan Untuk Setiap Transaksi Di duniacoin.net</p>
...
<div align="center"><img src="http://duniacoin.net/image/duniacoin.jpg" width="111" height="70"></div>
<div>
  <table cellpadding="0" width="100%" cellspacing="0" border="0" id="m_8412254246096925973backgroundTable">
    <tbody>
      <tr>
        <td><table cellpadding="0" width="620" align="center" cellspacing="0" border="0">
          <tbody>
            <tr>
                        ...
                        <tbody>
                          <tr>
                            <td colspan="3" align="center"><div>
                              <div align="center">
                                <h2>Konfirmasi Pendaftaran&nbsp;duniacoin.net</h2>
                              </div>
                            </div></td>
                          </tr>
                          <tr>
                            <td width="42">&nbsp;</td>
                            <td width="510" align="center"><div>
                              <div align="left">
                                <p>Hai '.$_POST['nama'].',</p>
                                <p align="center"><br>
                                Selamat Anda Sudah Terdaftar di duniacoin.net
                                <br>
                                  <br>
                                  Username :</p>
								  <div align="center">'.$username.'
								    </div>
								  <p align="center">Pasword : </p>
								  <p align="center">'.$pass1.' </p>
								  <p align="center">Token : </p>
								  <p align="center">'.$newtoken.'</p>
								  <p align="center">&nbsp;</p>
								  <p align="center">'.$message2.'</p>
								  <p align="center">Simpan Baik-Baik data Anda untuk setiap Transaksi <br>
                                  Token Akan Di Gunakan Untuk Setiap Transaksi di duniacoin.net<br>
                                  Sukses Untuk kita bersama                                </p>
								  <p><br>
                                </p>
                              </div>
                            </div></td>
                            ...
                            <div>
                              <table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
                                <tbody>
                                  ...
                                  <tr>
                                    <td width="60%" height="70" valign="middle"><div>
                                      <div align="left">PT. Dunia coin digital&nbsp;<br>
                                      Jakarta</div>
                                    </div></td></br>
                                    <td width="40%" height="70" align="right" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="right">
                                      <tbody>
                                        <tr>
                                          <td width="57%"></td>
...
<br>
<br>
<strong>Harap untuk tidak membalas email ini. Untuk pertanyaan lebih lanjut silakan kontak melalui info@duniacoin.net</strong>
<p>&nbsp;</p>
</body>
</html>
...
<?php
		...
		$to 	= $_POST['email'];
		$judul 	= "duniacoin Notification";
		$dari	= "From : noreply@duniacoin.net\n";
