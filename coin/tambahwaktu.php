...
function confirmation(noid, kat, page) {
	...
	if (answer){
		//alert("Bye bye!")
		window.location = "?e=tambahwaktu&page=" + kat + "&no=" + noid;
	}
}
</script>
<?
...
?>
<p align="center"><strong>EDIT PENAMBAHAN WAKTU PA</strong></p>
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" style="border:solid #CCCCCC 1px">
  <tr class="tbl_header">
    <td colspan="2">&nbsp;</td>
    <td colspan="6"><form id="form2" name="form2" method="post" action="?e=tambahwaktu&amp;kat=2" style="margin:0; padding:0">
          <label>
  ...
  <tr bgcolor="#FF0000" class="tbl_header">
    ...
    <td width="17%" align="center">BATAS TANGGAL</td>
    <td width="14%" align="center">BATAS BULAN</td>
    <td width="17%" align="center">BATAS TAHUN</td>
    <td width="12%" align="center">BATAS JAM</td>
    <td width="12%" align="center">BATAS MENIT</td>
...
?>  
  <tr class="<?= $class; ?>">
    ...
    <td align="center"><a href="?e=tambahwaktu&amp;page=edit&noid=<?= $row[0]; ?>"><img src="../admin/images/edit_f2.png" title="Edit Waktu Transfer" width="17" height="22" border="0" /></a></td>
  </tr>
<?
	$nom++;
}
...
?>
  <a href="?e=tambahwaktu&kat=<?= $kat; ?>&show=1" style="font-size:10px; color:#0000CC"><< First </a> | <a href="?e=tambahwaktu&kat=<?= $kat; ?>&show=<?= $previous; ?>" style="font-size:10px; color:#0000CC">< Previous </a> |
  <?php
...
?>
[ <a href="?e=tambahwaktu&kat=<?= $kat; ?>&show=<?= $i; ?>" style="font-size:10px; color:#0000CC">
<?= $i; ?>
</a> ]
<?php
...
?>
| <a href="?e=tambahwaktu&kat=<?= $kat; ?>&show=<?= $next; ?>" style="font-size:10px; color:#0000CC">Next ></a> | <a href="?e=tambahwaktu&kat=<?= $kat; ?>&show=<?= $paging; ?>" style="font-size:10px; color:#0000CC">Last >></a>
<?php
...
?>
  <?
	...
	case delete :
		...
		echo "<meta http-equiv='refresh' content='0;URL=?e=tambahwaktu'>";
	break;
...
if( isset($_POST['submit'])) {
	...
	echo "<meta http-equiv=\"refresh\" content=\"2; url=?e=tambahwaktu\">";
}
