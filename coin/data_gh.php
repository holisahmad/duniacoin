...
if($kat == 1) {
	$sql0 = $db->count_records("gh_start", "negara='Indonesia' $aktif");
	$sql = $db->select("*", "gh_start", "negara='Indonesia' $aktif", "", "", "", "$start, $limit");
	//mysql_close();
} else if($kat == 2) {
	...
	$sql0 = $db->count_records("gh_start", "negara='Malaysia' $aktif");
	$sql = $db->select("*", "gh_start", "negara='Malaysia' $aktif", "id desc", "", "", "$start, $limit");
} else {
...
?>
<p align="center"><strong>DATA RA (RA)</strong></p>
<table width="100%" border="0" cellspacing="0" cellpadding="5">
      ...
      <tr>
        <td><form action="" method="post" name="form1" id="form1" style="margin:0; padding:0">
          <label> Katagori Negara:
            ...
            <option value="?e=data_gh" selected="selected" <? echo $pilih; ?>>Semua negara</option>
            <option value="?e=data_gh&amp;kat=1&amp;sel3=<?= $sel; ?>" <? echo $sel3; ?>>Member Indonesia</option>
            <option value="?e=data_gh&amp;kat=0&amp;sel2=<?= $sel; ?>" <? echo $sel2; ?>>Member Malaysia</option>
          </select>
          </label>&nbsp;&nbsp;
  ...
  <tr bgcolor="#00FF00" class="tbl_header">
