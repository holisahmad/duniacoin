...
if ($sponsor == "") {
	...
	$db->select("username", "member", "username='$sponsor' and status='1'");
	$chkd_sp = $db->num_rows();
if ($chkd_sp == "") {
...
if ($upline == "") {
	...
	$db->select("username", "member", "username='$upline' and status='1'");
...
$db->insert("member", "", "'', '$username', '$pass', '$newtoken', '$nama', '$sponsor', '$upline', '$posisi', '$email', '$alamat', '$kota', '$hp', '$phone', '$negara', '$pinbb', '$foto', '$bank', '$norek', '$an', '$payment', '$acc', '$clientdate', '$setuju', '$clientdate', '$hari','0', '$paket_daftar', '0', '0', 'Reguler', '0' ");
...
$db->insert("history_card", "", "'', '$user_session', '',  '1', 'Aktivasi   $username', '$clientdate'");


$message= "Selamat Datang Di www.solutionprofit.Com User ID : ".$username.", Pass : ".$pass1." Token/pin : ".$newtoken." Segera Lengkapi data dimember area. Terima Kasih.";
