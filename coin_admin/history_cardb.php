...
<h2 align="center"><img src="images/icon-48-article.png" width="48" height="48" align="absmiddle"> History Tiket RO</h2>
<?
switch($page) {
	default :
...
//$bulan=array("Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember");
	...
	$dtto = "$tahun-$bulan-31";
		...
		?>
              ...
              <td width="35%">Jumlah Tiket Aktivasi : <strong>
              <?= $db->totalpinro("('$dtfrom')"); ?></strong></td>
            </tr>
        </table></td>
      </tr>
      <tr class="tbl_header">
        <td width="4%" align="center">#</td>
        <td width="22%" align="center">Username</td>
...
//$db->select("*", "member", $kat);
	...
	$numrows = $db->count_records("history_cardro", "(tgl between '$dtfrom' and '$dtto')");
	$db->select("username, banyak_tiket, ket, tgl", "history_cardro", "(tgl between '$dtfrom' and '$dtto')", "tgl desc");
//$j=$db->num_rows();
...
?>
            <a href="?m=history_tiketb&show=1" style="font-size:10px; color:#0000CC"><< Awal </a> | <a href="?m=history_tiketb&show=<?= $previous; ?>" style="font-size:10px; color:#0000CC">< Sebelumnya </a> |
          <?php
...
?>
          [ <a href="?m=history_tiketb&show=<?= $i; ?>" style="font-size:10px; color:#0000CC">
            <?= $i; ?>
            </a> ]
          <?php
...
?>
          | <a href="?m=history_tiketb&show=<?= $next; ?>" style="font-size:10px; color:#0000CC">Selanjutnya ></a> | <a href="?m=history_tiketb&show=<?= $paging; ?>" style="font-size:10px; color:#0000CC">Terakhir >></a>
          <?php
