...
?>
  ...
  <form name="form3" method="post" action="?m=aktivasiro2&page=ordform">
    <p align="center"><strong><font color="#000066" size="5" face="Verdana, Arial, Helvetica, sans-serif">Form Aktivasi RO II Member </font></strong></p>
  ...
  <?
	break;
	case ordform :
	$db->aktivasiro2("$username");
?>
  </font>
    <div align="center">
<font color="#000066" size="5" face="Verdana, Arial, Helvetica, sans-serif"><strong> Proses aktivasi RO II Sukses </strong></font>
<p>&nbsp;</p></div>
<p align="center">&nbsp;</p>
    <?
