...
function confirmation(mid, page, action) {
	...
	if (answer){
		...
		window.location = "?m=sudahbayar&page=" + page + "&mid=" + mid + "&action=" + action;
...
$dd=mysql_query("select * from transfer where valid=1") ;
$totalsemua = 0;
while($rowd=mysql_fetch_row($dd)) {
$totalsemua = $totalsemua + $rowd[6];
}
...
<h2 align="center"><img src="images/edit_f2.png" width="32" height="32" align="absmiddle" /> Rekap Sudah Bayar Berdasarkan Bank</h2>

<div id="menu_button2"><strong>Total Terbayar : 
    <?= rupiah ($totalsemua) ; ?> 
</strong></div>
...
if($kat == "") {
	...
	$db->select("id, username, tanggal, nama, bank, norek, an, saldo, adm, pajak, bonus, status", "bayartoday", "status=1", $order, "", "", "$start, $limit");
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <form action="?m=sudahbayar&amp;page=konfirm" method="post"  name="bayar">
    <tr class="tbl_header">
...
?>
  ...
  <a href="../admin/?m=sudahbayar&amp;kat=<?= $kat; ?>&amp;show=1" style="font-size:10px; color:#0000CC"><< Awal </a> | <a href="../admin/?m=sudahbayar&amp;kat=<?= $kat; ?>&amp;show=<?= $previous; ?>" style="font-size:10px; color:#0000CC">< Sebelumnya </a> |
...
[ <a href="../admin/?m=sudahbayar&amp;kat=<?= $kat; ?>&amp;show=<?= $i; ?>" style="font-size:10px; color:#0000CC">
...
| <a href="../admin/?m=sudahbayar&amp;kat=<?= $kat; ?>&amp;show=<?= $next; ?>" style="font-size:10px; color:#0000CC">Selanjutnya ></a> | <a href="../admin/?m=sudahbayar&amp;kat=<?= $kat; ?>&amp;show=<?= $paging; ?>" style="font-size:10px; color:#0000CC">Terakhir >></a>
...
<?
	...
	case delete :
		...
		echo "<meta http-equiv='refresh' content='0;URL=?m=sudahbayar'>";
...
<td colspan="12" align="center" style="color:#FF0000"> Hallo </strong></td>
    </tr>
<?
...
//$db->smsnotifikasi ($hp , $message) ;
	...
	?>
<form action="" method="post" enctype="?m=sudahbayar&amp;page=konfirm" name="bayar" id="bayar">
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr class="tbl_header">
      ...
      <td width="6%" align="center">Pajak</td>
...
?>
    <tr>
     ...
     <td><?= date("d-m-Y", strtotime($row[2])); ?>
	  ...
	  <input name="j" type="hidden" id="j" value="<?= $j; ?>" />
	 </td>
    <td><?= $row[1]; ?>
...
?>
    <tr>
      <td colspan="6" align="center"><input name="submit3" type="submit" id="submit" value="PROSES" class="tombol" />
        &nbsp;
        <input name="submit22" type="button" id="submit22" value="BATAL" class="tombol" onclick="javascript:bayartoday.go(-1)" /></td>
    </tr>
  </table>
</form>
	<p>&nbsp;</p>
