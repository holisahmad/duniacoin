...
<h2 align="center"><img src="images/icon-48-article.png" width="48" height="48" align="absmiddle"> History Tiket</h2>
<?
switch($page) {
	default :
...
//$db->select("*", "member", $kat);
	...
	$numrows = $db->count_records("history_card", "(tgl between '$dtfrom' and '$dtto')");
	$db->select("username, masuk, keluar, ket, tgl", "history_card", "(tgl between '$dtfrom' and '$dtto')", "id desc");
//$j=$db->num_rows();
...
?>
            <a href="?m=history_tiket&show=1" style="font-size:10px; color:#0000CC"><< Awal </a> | <a href="?m=history_tiket&show=<?= $previous; ?>" style="font-size:10px; color:#0000CC">< Sebelumnya </a> |
          <?php
...
?>
          [ <a href="?m=history_tiket&show=<?= $i; ?>" style="font-size:10px; color:#0000CC">
            <?= $i; ?>
            </a> ]
          <?php
...
?>
          | <a href="?m=history_tiket&show=<?= $next; ?>" style="font-size:10px; color:#0000CC">Selanjutnya ></a> | <a href="?m=history_tiket&show=<?= $paging; ?>" style="font-size:10px; color:#0000CC">Terakhir >></a>
          <?php
