...
<h2 align="center"><img src="images/icon-48-user.png" width="48" height="48" align="absmiddle" /> Order Tiket </h2>
...
if($kat == "") {
	...
	$numrows = $db->count_records("order_aktivasi", "paket=1");

	$db->select("id, username, nama, hp, jumlah, tgl, limite, bank, total, jenis, status", "order_aktivasi", "status=0", $order, "", "", "$start, $limit");
